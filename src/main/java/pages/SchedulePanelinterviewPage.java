...
public class SchedulePanelinterviewPage {
    ...
    private By panelOptionBtn = By.xpath("//button[contains(.,'Panel')]");
   ...
   //  WebElement startTimeInput = driver.findElement(By.xpath("//input[contains(@placeholder,'Start Time') or contains(@aria-label,'start time')]"));
    ...
    public void choosePanelOption() {
        wait.until(ExpectedConditions.elementToBeClickable(panelOptionBtn)).click();
    }
